...
import (
	build "github.com/bazelbuild/bazelapis/src/main/protobuf/build"
...
type ConfiguredTarget struct {
	...
	// Deprecated: Marked as deprecated in src/main/protobuf/analysis_v2.proto.
...
func (x *CqueryResult) Reset() {
	*x = CqueryResult{}
	mi := &file_src_main_protobuf_analysis_v2_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CqueryResult) Descriptor() ([]byte, []int) {
	return file_src_main_protobuf_analysis_v2_proto_rawDescGZIP(), []int{13}
}
...
func (x *ParamFile) Reset() {
	*x = ParamFile{}
	mi := &file_src_main_protobuf_analysis_v2_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ParamFile) Descriptor() ([]byte, []int) {
	return file_src_main_protobuf_analysis_v2_proto_rawDescGZIP(), []int{14}
}
...
func (x *PathFragment) Reset() {
	*x = PathFragment{}
	mi := &file_src_main_protobuf_analysis_v2_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PathFragment) Descriptor() ([]byte, []int) {
	return file_src_main_protobuf_analysis_v2_proto_rawDescGZIP(), []int{15}
}
...
const file_src_main_protobuf_analysis_v2_proto_rawDesc = "" +
	"\n" +
	...
	"&com.google.devtools.build.lib.analysisB\x10AnalysisProtosV2b\x06proto3"

var (
	file_src_main_protobuf_analysis_v2_proto_rawDescOnce sync.Once
	file_src_main_protobuf_analysis_v2_proto_rawDescData []byte
)
...
func file_src_main_protobuf_analysis_v2_proto_rawDescGZIP() []byte {
	file_src_main_protobuf_analysis_v2_proto_rawDescOnce.Do(func() {
		file_src_main_protobuf_analysis_v2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_src_main_protobuf_analysis_v2_proto_rawDesc), len(file_src_main_protobuf_analysis_v2_proto_rawDesc)))
	})
	return file_src_main_protobuf_analysis_v2_proto_rawDescData
}

var file_src_main_protobuf_analysis_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_src_main_protobuf_analysis_v2_proto_goTypes = []any{
	...
	(*Fragment)(nil),             // 8: analysis.Fragment
	(*FragmentOptions)(nil),      // 9: analysis.FragmentOptions
	(*Option)(nil),               // 10: analysis.Option
	(*KeyValuePair)(nil),         // 11: analysis.KeyValuePair
	(*ConfiguredTarget)(nil),     // 12: analysis.ConfiguredTarget
	(*CqueryResult)(nil),         // 13: analysis.CqueryResult
	(*ParamFile)(nil),            // 14: analysis.ParamFile
	(*PathFragment)(nil),         // 15: analysis.PathFragment
	(*build.Target)(nil),         // 16: blaze_query.Target
}
var file_src_main_protobuf_analysis_v2_proto_depIdxs = []int32{
	...
	15, // 7: analysis.ActionGraphContainer.path_fragments:type_name -> analysis.PathFragment
	11, // 8: analysis.Action.environment_variables:type_name -> analysis.KeyValuePair
	11, // 9: analysis.Action.execution_info:type_name -> analysis.KeyValuePair
	14, // 10: analysis.Action.param_files:type_name -> analysis.ParamFile
	11, // 11: analysis.Action.substitutions:type_name -> analysis.KeyValuePair
	11, // 12: analysis.AspectDescriptor.parameters:type_name -> analysis.KeyValuePair
	8,  // 13: analysis.Configuration.fragments:type_name -> analysis.Fragment
	9,  // 14: analysis.Configuration.fragment_options:type_name -> analysis.FragmentOptions
	10, // 15: analysis.FragmentOptions.options:type_name -> analysis.Option
	16, // 16: analysis.ConfiguredTarget.target:type_name -> blaze_query.Target
	7,  // 17: analysis.ConfiguredTarget.configuration:type_name -> analysis.Configuration
	12, // 18: analysis.CqueryResult.results:type_name -> analysis.ConfiguredTarget
	7,  // 19: analysis.CqueryResult.configurations:type_name -> analysis.Configuration
...
func file_src_main_protobuf_analysis_v2_proto_init() {
	...
	file_src_main_protobuf_analysis_v2_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_src_main_protobuf_analysis_v2_proto_rawDesc), len(file_src_main_protobuf_analysis_v2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
