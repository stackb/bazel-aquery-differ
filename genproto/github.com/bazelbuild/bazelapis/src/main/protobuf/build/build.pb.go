...
import (
	stardoc_output "github.com/bazelbuild/bazel/src/main/protobuf/stardoc_output"
...
type Rule struct {
	...
	RuleClassInfo              *stardoc_output.RuleInfo `protobuf:"bytes,17,opt,name=rule_class_info,json=ruleClassInfo" json:"rule_class_info,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *Rule) GetRuleClassInfo() *stardoc_output.RuleInfo {
	if x != nil {
...
const file_src_main_protobuf_build_proto_rawDesc = "" +
	"\n" +
...
var (
	...
	file_src_main_protobuf_build_proto_rawDescData []byte
)

func file_src_main_protobuf_build_proto_rawDescGZIP() []byte {
	file_src_main_protobuf_build_proto_rawDescOnce.Do(func() {
		file_src_main_protobuf_build_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_src_main_protobuf_build_proto_rawDesc), len(file_src_main_protobuf_build_proto_rawDesc)))
	})
...
var file_src_main_protobuf_build_proto_goTypes = []any{
	...
	(*stardoc_output.RuleInfo)(nil),              // 31: stardoc_output.RuleInfo
}
var file_src_main_protobuf_build_proto_depIdxs = []int32{
	...
	31, // 13: blaze_query.Rule.rule_class_info:type_name -> stardoc_output.RuleInfo
	13, // 14: blaze_query.RuleSummary.rule:type_name -> blaze_query.Rule
	13, // 15: blaze_query.RuleSummary.dependency:type_name -> blaze_query.Rule
	5,  // 16: blaze_query.SourceFile.license:type_name -> blaze_query.License
	3,  // 17: blaze_query.Target.type:type_name -> blaze_query.Target.Discriminator
	13, // 18: blaze_query.Target.rule:type_name -> blaze_query.Rule
	18, // 19: blaze_query.Target.source_file:type_name -> blaze_query.SourceFile
	19, // 20: blaze_query.Target.generated_file:type_name -> blaze_query.GeneratedFile
	16, // 21: blaze_query.Target.package_group:type_name -> blaze_query.PackageGroup
	17, // 22: blaze_query.Target.environment_group:type_name -> blaze_query.EnvironmentGroup
	20, // 23: blaze_query.QueryResult.target:type_name -> blaze_query.Target
	4,  // 24: blaze_query.AllowedRuleClassInfo.policy:type_name -> blaze_query.AllowedRuleClassInfo.AllowedRuleClasses
	1,  // 25: blaze_query.AttributeDefinition.type:type_name -> blaze_query.Attribute.Discriminator
	22, // 26: blaze_query.AttributeDefinition.allowed_rule_classes:type_name -> blaze_query.AllowedRuleClassInfo
	24, // 27: blaze_query.AttributeDefinition.default:type_name -> blaze_query.AttributeValue
	24, // 28: blaze_query.AttributeValue.list:type_name -> blaze_query.AttributeValue
	30, // 29: blaze_query.AttributeValue.dict:type_name -> blaze_query.AttributeValue.DictEntry
	23, // 30: blaze_query.RuleDefinition.attribute:type_name -> blaze_query.AttributeDefinition
	25, // 31: blaze_query.BuildLanguage.rule:type_name -> blaze_query.RuleDefinition
	2,  // 32: blaze_query.Attribute.SelectorEntry.tristate_value:type_name -> blaze_query.Attribute.Tristate
	5,  // 33: blaze_query.Attribute.SelectorEntry.license:type_name -> blaze_query.License
	6,  // 34: blaze_query.Attribute.SelectorEntry.string_dict_value:type_name -> blaze_query.StringDictEntry
	11, // 35: blaze_query.Attribute.SelectorEntry.fileset_list_value:type_name -> blaze_query.FilesetEntry
	8,  // 36: blaze_query.Attribute.SelectorEntry.label_list_dict_value:type_name -> blaze_query.LabelListDictEntry
	10, // 37: blaze_query.Attribute.SelectorEntry.string_list_dict_value:type_name -> blaze_query.StringListDictEntry
	7,  // 38: blaze_query.Attribute.SelectorEntry.label_dict_unary_value:type_name -> blaze_query.LabelDictUnaryEntry
	9,  // 39: blaze_query.Attribute.SelectorEntry.label_keyed_string_dict_value:type_name -> blaze_query.LabelKeyedStringDictEntry
	27, // 40: blaze_query.Attribute.Selector.entries:type_name -> blaze_query.Attribute.SelectorEntry
	1,  // 41: blaze_query.Attribute.SelectorList.type:type_name -> blaze_query.Attribute.Discriminator
	28, // 42: blaze_query.Attribute.SelectorList.elements:type_name -> blaze_query.Attribute.Selector
	24, // 43: blaze_query.AttributeValue.DictEntry.value:type_name -> blaze_query.AttributeValue
...
func file_src_main_protobuf_build_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_src_main_protobuf_build_proto_rawDesc), len(file_src_main_protobuf_build_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   26,
			NumExtensions: 0,
			NumServices:   0,
