...
import (
	...
	action_cache "github.com/bazelbuild/bazelapis/src/main/protobuf/action_cache"
	command_line "github.com/bazelbuild/bazelapis/src/main/protobuf/command_line"
	failure_details "github.com/bazelbuild/bazelapis/src/main/protobuf/failure_details"
	invocation_policy "github.com/bazelbuild/bazelapis/src/main/protobuf/invocation_policy"
...
var file_src_main_java_com_google_devtools_build_lib_buildeventstream_proto_build_event_stream_proto_goTypes = []any{
	...
	(*invocation_policy.InvocationPolicy)(nil),                  // 95: blaze.invocation_policy.InvocationPolicy
	(*failure_details.FailureDetail)(nil),                       // 96: failure_details.FailureDetail
	(*anypb.Any)(nil),                                           // 97: google.protobuf.Any
	(*durationpb.Duration)(nil),                                 // 98: google.protobuf.Duration
	(*command_line.CommandLine)(nil),                            // 99: command_line.CommandLine
	(*action_cache.ActionCacheStatistics)(nil),                  // 100: blaze.ActionCacheStatistics
	(*metrics.PackageLoadMetrics)(nil),                          // 101: devtools.build.lib.packages.metrics.PackageLoadMetrics
	(failure_details.Worker_Code)(0),                            // 102: failure_details.Worker.Code
}
